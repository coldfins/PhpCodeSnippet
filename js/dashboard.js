			...
			snapshot.forEach(function(childSnapshot) {
				...
				if(childSnapshot.hasChild("SubCategory")){
					...
					$.map(childData.SubCategory, function(value, index) {
						if(value.parentcategory == "Quick Dive" && value.Session && value.Bundle == ""){
...
alert(value.subcategory_name);
									...
									if(value.parentcategory == "Deep Dive" || value.Bundle == ""){
