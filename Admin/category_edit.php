    ...
    <script src="https://www.gstatic.com/firebasejs/4.9.0/firebase.js"></script>
       <script type="text/javascript" src="../js/credential.js"></script>
        <script src="js/check_login.js "></script>
            <script type="text/javascript" src="../Template/register_user.js"></script>
                                    ...
                                    <div class="form-line error">
                                     ...
                                     <!--  <form id="my-awesome-dropzone" action="/upload" class="dropzone">  
                                            ...
                                            <div class="fallback"> <!-- this is the fallback if JS isn't working -->
                                                ...
                                                <div class='icon'></div>
                                                <input name="file" class="input-file check-image-size input-file" id="catimage" type="file" data-min-width="1920" data-min-height="1080" data-max-width="1920" data-max-height="1080" onchange="uplaodfile()" accept="image/*" />
                                                </div>
                                                <br>
