                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                              ...
                              <!--  <label id="name-error" class="error" for="name">This field is required.</label>-->
                               ...
                               <div class="form-group form-float">
                                    ...
                                    <label class="form-label">Quote Image (464 X 464)</label>
                                                ...
                                                <input name="qimage" class=" form-control " id="qimage" type="file" onchange="uplaodqimg()" accept="image/*" />
                                                <br>
                            ...
                            <!---<div id="frmFileUpload" class="dropzone" style="width:25%;">
                                ...
                                <div  id="frmFileUpload" class="dropzone fallback">
                                    <input name="meditation" id="dropmed" type="file" multiple />
                                </div>
                            </div>--->
                    ...
                    <div class="form-group form-float audio2">
                                ...
                                <?php
                                    ...
                                    <div class="form-line error " ><label class="form-label">'.$key.'</label><br><br><div class="demo-checkbox tags">';
                                                foreach($val as $k => $v){
                                                    echo '<input type="radio" name="'.$a.'" id="'.$v.'" class="with-gap" value="'.$v.'">
                                        <label for="'.$v.'">'.$v.'</label>';
                                                $j++;
                                                }
                                                echo "</div></div></div>";
                                        ...
                                        //die;
                                    ?>
<!--<input type="text" id="tags" name="tags" style="width:1px;height:0px;">---->
...
nwaudio = [];
				...
				alert(nwaudio.indexOf(file.name));
					  var name = file.name; 
...
/*				var c = $("#cat option:selected").val();
				var s = $("#subcat option:selected").val();
				var b = $(this).val();
				alert("/Category/"+c+"Subcategory/"+s+"/Bundle/"+b);
				firebase.database().ref("/Category/"+c+"Subcategory/"+s+"/Bundle/"+b).on("value", function(snapshot) {
					snapshot.forEach(function(childSnapshot) {
						// key
						var key = childSnapshot.key;
						// value, could be object
...
/*                    "chk_hopacc": {
                ...
                messages: {
                  ...
                  "chk":"Please select at least one tag",
