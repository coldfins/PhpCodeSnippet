        ...
        <?php //include'header.php'; ?>
          <div id="result"></div>
            ...
            color:#fff !important;">JOIN FOR FREE</a>
                       <a href="registration.php" class="btn1 mx-2 px-4 my-2" style="letter-spacing:3px; padding-top: 10px; padding-bottom: 10px; color: #FFF; text-decoration: none; border-color: #fff;">LET'S COLLABARATE</a>
                      ...
                      <div class="container">
                        <div class="row mt-5">
                            ...
                            <div class="col-lg-6">
                              ...
                              <br><br>
                               <a href="Subscription" class="btn btn-primary btnpos" style="border-color: #7dd3d5;   background-color: #7dd3d5;">S U B S C R I B E &nbsp; N O W</a>
                               <br><br>
                                <a href="Registration" class="btn btn-primary btnpos" style="border-color: #7dd3d5;  background-color: #7dd3d5;"> &nbsp;J O I N &nbsp; F O R &nbsp; F R E E &nbsp;  </a>
                                <br><br>
                                <div>
