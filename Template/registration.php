...
<html lang="en">
  ...
  return obj;
			...
			alert(str.indexOf("referby"));
			if (window.location.href.indexOf('?referby=') > 0) {
                alert(window.atob(getAllUrlParams().referby));
            }
			$('.bdate').datepicker({
			dateFormat: 'yy-mm-dd',
                changeMonth: true,
					 ...
					 <form>
									...
									<div class="form-group-log">
									  ...
									  <button  type="button"  id="submit" onclick="btnclick();" name="login"  class="btn1 " style="background-color: #7dd3d5; letter-spacing: 4; border: none; border-radius: unset;  line-height: 27px; cursor: pointer; outline: none; color: white;"><i class="fa fa-spinner fa-spin"></i>GET STARTED</button>
                                         <br><br>
                                    <center><img src="./img/or.png" style="width: 100%" class="img-responsive"></center>
       								</div>
...
<br><br>
 ...
 <br>
                                ...
                                <p style="text-align: center;">By signing up, you agree to Dive thru<br> <a href="Terms&Conditions" style="color:#5191d6;">  Terms & Conditions</a> And <a href="PrivacyPolicy" style="color:#5191d6;">Privacy Policy</a></p>
						  </div>
