...
<script>
  ...
  <body style="padding-top: 118px;">
        ...
        <?php //include'header.php'; ?>
          <div id="result"></div>
            ...
            color:#fff !important;">DOWNLOAD MEDIA KIT</a>
                       <a href="contact.php" class="btn1 mx-2 px-4 my-2 btn-pad" style="letter-spacing:3px; padding-top: 10px; padding-bottom: 10px; color: #FFF; text-decoration: none; border-color: #fff;">CONTACT</a>
    ...
    <div class="container">
		...
		<a href="Contact" style="text-decoration: none;color: #7dd3d5;" class="btn1 btn-primary3 btn-primary5 py-2 mx-2 mt-3">C O N T A C T</a>
...
you with everything you need to Dive Thru what you go Thru.
		...
		<div class="btn1 btn-primary3 py-2 mx-2 mt-3">D O W N L O A D &nbsp; M E D I A &nbsp; K I T</div>
		<a class="btn1 btn-primary3 btn-primary4 py-2 mx-2 mt-3" style="text-decoration:none;color: #7dd3d5;" href="Collaboration">L E T ' S&nbsp; C O L L A B O R A T E</a>
                      ...
                      <div class="container">
                        <div class="row mt-5">
                            ...
                            <div class="col-lg-6">
                              ...
                              <br><br>
                               <a href="Subscription" class="btn btn-primary btnpos" style="border-color: #7dd3d5; box-shadow: none !important;  background-color: #7dd3d5;">S U B S C R I B E &nbsp; N O W</a>
                               <br><br>
                                <a  href="Registration" class="btn btn-primary btnpos" style="border-color: #7dd3d5;box-shadow: none !important;   background-color: #7dd3d5;"> &nbsp;J O I N &nbsp; F O R &nbsp; F R E E &nbsp;  </a>
                                <br><br>
                                <div>
