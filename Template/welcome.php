...
<div class="slideshow-container" style="width:100%; height: 100%; background-color: lightblue;">
    <div>
        <a href="DashBoard"><img class="buttonross"  onclick="redirect_page();" src="./img/ic_close.png"></a>
    </div>
...
<div class="mySlides fade" style="background: #b679d3 url('./img/spls 1.png') no-repeat;">
  <div class="text lastimageTextView">
    <br><br><br>
       <a class="btn btn-primary marketbtn" href="DashBoard" style=" border-color: #7dd3d5; text-decoration: none; background-color: #7dd3d5;">S T A R T &nbsp; T O &nbsp; D I V E T H R U &nbsp;</a>
    </p><br><br>
