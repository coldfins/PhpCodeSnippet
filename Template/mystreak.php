...
<!--  <script src="https://www.gstatic.com/firebasejs/4.9.0/firebase.js"></script> -->
 ...
 <script type="text/javascript" src="js/tagpopup.js"></script>
<script>
...
<div class="container-fluid  py-5" style="padding-bottom: 0px !important;margin-top: 9% !important;">
		...
		<div class="row justify-content-center text-center">
			...
			<div class="col-12">
                   <div class=" center triangle">
                       <h1 class="pt-3 currentday" style="color: #9a5bb6;font-weight:400;">0</h1>
                   </div>
                
			</div>
			
			<div class="col-12 col-md-12">
			    <h2 class="pt-5" style="text-transform: uppercase;font-size:26px;color:#727272;">DAYS IN A ROW</h2>
			</div>
		</div>
