                      ...
                      <div class="container">
                        <div class="row mt-5">
                            ...
                            <div class="col-lg-6">
                              ...
                              <br>
                               <a href="Subscription"  class="btn3 btnpos" style="border-color: #7dd3d5; text-decoration: none; color: #FFF;   background-color: #7dd3d5;">S U B S C R I B E &nbsp; N O W</a>
                               <br><br>
                                <a href="Registration" class="btn3 btnpos" style="border-color: #7dd3d5; text-decoration: none; color: #FFF; background-color: #7dd3d5;"> &nbsp;J O I N &nbsp; F O R &nbsp; F R E E &nbsp;  </a>
                                <br><br>
                                <div>
	...
	$(".get-button").click(function(){
		...
		if($(this).html() == "UNSUBSCRIBE"){
			...
			if(subcrb_type=="paypal"){
				...
				var user = JSON.parse(window.localStorage.getItem('user'));
				$.post("SubscriptionCancel.php", {"id": sbid}, function(result){
