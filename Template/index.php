...
.global__loadBar___3-9Uf {
    width: 100%;
    height: 2px;
    transition: opacity 500ms linear, -webkit-transform 6s ease-out;
    transition: opacity 500ms linear, transform 6s ease-out;
    transition: opacity 500ms linear, transform 6s ease-out, -webkit-transform 6s ease-out;
...
.top-0 {
    ...
    #progress dd,#progress dt {
        ...
        top: 0;
        height: 2px;
        -moz-box-shadow: #874aa1  1px 0 6px 1px;
        -ms-box-shadow: #874aa1  1px 0 6px 1px;
        -webkit-box-shadow: #874aa1  1px 0 6px 1px;
        box-shadow: #874aa1  1px 0 6px 1px;
                  ...
                  <div class="container">
                    <div class="row slide1">
                      <div class="col-xl-12 mx-auto">
                       ...
                       <a href="subscription.php" class="btn1 mx-2  my-2 active2" style="letter-spacing:3px; text-decoration: none; padding-left:21px !important;
                       padding-right:21px !important; background-color:#7DD3D5 !important;
                      border:none;
            color:#fff !important;">SUBSCRIBE NOW</a>
                       <a href="registration.php" class="btn1 mx-2 px-4 my-2" style="letter-spacing:3px; text-decoration: none; border-color: #fff;">JOIN FOR FREE</a>
                ...
                <section class="features-icons bg-white text-center">
                      <div class="container">
                        <div class="row pb-5">
                         ...
                         <a href="subscription.php" class="btn1 mx-2  mt-2  mb-2 active1" style="letter-spacing:3px; text-decoration: none; padding-left:21px !important;
                       padding-right:21px !important; background-color:#7DD3D5 !important;
                      border:none;
            color:#fff !important;">SUBSCRIBE NOW</a>
                       <a href="registration.php" class="btn1 mx-2 px-4 mt-2 mb-2 " style="letter-spacing:3px; text-decoration: none; border-color:#7DD3D5; color:#7DD3D5;">JOIN FOR FREE</a>
                      </div>
                    </section>
					<!------------------------->
                        ...
                        <div class="row mt-5">
                            ...
                            <div class="col-lg-6">
                              ...
                              <br>
                               ...
                               <a href="subscription.php" class="btn1 btnpos mx-2  mt-2  mb-2 active1" style="letter-spacing:3px; text-decoration: none; cursor: pointer;  background-color:#7DD3D5 !important;
                      border:none;
            color:#fff !important;">SUBSCRIBE NOW</a>
                               <br>
